...
<!DOCTYPE html>
<html lang="en" ng-app="myApp"  ng-init="ctx='${ctx}';custMd5='${custMd5 }';shopName='${shopName }';custId='${retail.custId }';title='红码';nickname='${nickname }';headimgurl='${headimgurl }';isActived='${isActived }';isTouchA='false';shopQRCode='${shopQRCode }';license='${license }';iTimer=''">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="user-scalable=no, width=device-width, initial-scale=1.0" />
    <title ng-bind="title"></title>
    <link href="${ctx }/test/dist/css/bootstrap.min.css" rel="stylesheet" />
    <link href="${ctx }/test/font/iconfont.css" rel="stylesheet" />
    ...
    <style type="text/css">
       .Close{background:red;color: #fff;border-radius: 50%;font-size:25px;display: block;width: 40px;margin: 0 auto;text-align: center;}
    </style>
</head>
<body>

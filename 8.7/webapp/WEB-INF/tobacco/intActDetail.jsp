...
<!DOCTYPE html>
<html lang="en" ng-app="myApp"  ng-init="ctx='${ctx}';custMd5='${custMd5 }';typeText='营销活动';operType='1';title='营销活动明细';custId='${custId }'">
<head>
    <meta charset="UTF-8">
    ...
    <script type="text/javascript">
	    myApp.config(function($stateProvider , $urlRouterProvider){
	    	$urlRouterProvider.otherwise("/intActDetail");
	
	    	$stateProvider.state('intActDetail' , {
	    		url : '/intActDetail',
	    		templateUrl : url+'/hm/html/intActDetail.html',
	    	});
	    });

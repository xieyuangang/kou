...
<head>
    ...
    <script type="text/javascript" src="${ctx}/exchange/js/configPoint.js?random=<%=Math.random()%>"></script>
    <script type="text/javascript" src="${ctx}/exchange/js/factory.js"></script>
    <script type="text/javascript" src="${ctx}/exchange/js/pointCtroller.js"></script>

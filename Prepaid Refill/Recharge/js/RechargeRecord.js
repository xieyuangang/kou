...
$(function () {
   ...
   //console.log(num[1]);
    ...
    // var transDate =now;
    var mobile=num[1].split("&");
    //var memberId =mobile[0];

    //alert(JSON.stringify(date));
    var memberId = 'bwgzydVRnlfJjGmJ';
    var transDate = "20171026";
        ...
        success: function (data) {	//成功回调
            ...
            var Cycle = "";
             ...
             Cycle+="<span>"+time[1]+"</span></div><div style='width:25% '>";
                     if(appType==1000){
                         Cycle+="<h4>话费充值</h4></div>";
                     }else {
                         Cycle+="<h4>话费充值</h4></div>";
                     }

                     if(data.body.transrecordList[i].status==1 || data.body.transrecordList[i].status==0){
                         Cycle+="<div style='width:40% '><span>-"+data.body.transrecordList[i].realAmt+"</span><span style='font-size: 0.9rem;line-height: 1rem;'>给"+data.body.transrecordList[i].destNo+"充值</span></div>"

                     }else {
                         Cycle+="<div style='width:40% '><span style='opacity: 0;'>00</span><span style='font-size: 0.9rem;line-height: 1rem;'>给"+data.body.transrecordList[i].destNo+"充值</span></div>"

                     }
             if(status==0){
                   Cycle+="<div style='width: 7%'><span class='Result' style='color:#999'>充值失败</span></div></li>";
               }else if(status==1){
                   Cycle+="<div style='width: 7%'><span class='Result' style='color: #55a532'>充值成功</span></div></li>";
               }else if(status==2){
                   Cycle+="<div style='width: 7%'><span class='Result' style='color: #55a532'>等待充值</span></div></li>";
               }if(status==3){
                   Cycle+="<div style='width: 7%'><span class='Result' style='color: #55a532'>充值中</span></div></li>";
               }if(status==4){
                   Cycle+="<div style='width: 7%'><span class='Result' style='color: #55a532'>返销审核中</span></div></li>";
               }if(status==5){
                   Cycle+="<div style='width: 7%'><span class='Result' style='color: #55a532'>返销中</span></div></li>";
               }if(status==6){
                   Cycle+="<div style='width: 7%'><span class='Result' style='color: #55a532'>返销成功</span></div></li>";
               }
           }
